...
class CodeRoastIpcConan(ConanFile):
    ...
    Downstream consumers should depend on the specific packages they need:
      - requires = "coderoast_ipc_core/1.4.4"       # Just transport layer
      - requires = "coderoast_ipc_consumer/1.4.4"   # Consumer adapter + core
      - requires = "coderoast_ipc_producer/1.4.4"   # Producer helper + core
