...
class CodeRoastIpcConan(ConanFile):
    ...
    Downstream consumers should depend on the specific packages they need:
      - requires = "coderoast_ipc_core/1.2.1"       # Just transport layer
      - requires = "coderoast_ipc_consumer/1.2.1"   # Consumer adapter + core
      - requires = "coderoast_ipc_producer/1.2.1"   # Producer helper + core
