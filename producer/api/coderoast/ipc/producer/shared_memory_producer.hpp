...
// Frame builder: tracks global + per-shard sequences and assembles frame headers.
// Callers provide the payload bytes; this class handles sequencing and header setup.
